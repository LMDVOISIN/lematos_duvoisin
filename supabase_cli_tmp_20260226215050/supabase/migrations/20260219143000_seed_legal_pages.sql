...
<h2>9. Resiliation</h2>
<p>Le compte peut etre resilie par l'utilisateur ou suspendu en cas de violation des CGU.</p>$$
),
(
  'cgv',
...
<p>Une mediation est proposee. A defaut d'accord, competence des tribunaux du siege social.</p>$$
),
(
