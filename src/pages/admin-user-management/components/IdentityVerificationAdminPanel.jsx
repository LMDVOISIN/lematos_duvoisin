...
const IdentityVerificationAdminPanel = ({
  className = '',
  defaultStatusFilter = 'pending',
  onDocumentsReviewed = null
}) => {
  ...
  const handleApprove = async (document) => {
    try {
      ...
      await onDocumentsReviewed?.(data);
    } catch (error) {
  ...
  return (
    <section className={`rounded-lg border border-border bg-white shadow-elevation-1 ${className}`}>
      <div className="border-b border-border px-4 py-4 md:px-6">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          <div>
            <p className="text-xs font-semibold uppercase tracking-[0.18em] text-[#0f7081]">
              Administration
            </p>
            ...
            <p className="mt-2 max-w-3xl text-sm text-muted-foreground">
              Validation plateforme uniquement. Le proprietaire ne voit jamais le document.
            </p>
          </div>
      ...
      <div className="p-4 md:p-6">
        ...
        <div className="mt-6 overflow-hidden rounded-3xl border border-slate-200">
          <div className="hidden grid-cols-[1.1fr_0.9fr_1fr_0.9fr_0.8fr_auto] gap-4 bg-slate-50 px-5 py-4 text-xs font-semibold uppercase tracking-[0.16em] text-slate-500 lg:grid">
          ...
          {loading ? (
            ...
            <div className="divide-y divide-slate-200">
              {filteredDocuments?.map((document) => (
                <div
                  key={document?.id}
                  className="grid gap-4 px-5 py-5 lg:grid-cols-[1.1fr_0.9fr_1fr_0.9fr_0.8fr_auto] lg:items-center"
                >
                  <div>
...
export default IdentityVerificationAdminPanel;
