...
(1, 'Comment fonctionne la caution ?', 'La caution est geree uniquement via empreinte bancaire (CB). C?est une autorisation bancaire non d?bit?e au paiement de la location, puis lib?r?e automatiquement ? la cl?ture sans litige. Aucun frais de traitement n?est applique tant qu?elle n?est pas capturee. En cas de dommage ou de non-restitution valide, elle peut etre capturee totalement ou partiellement selon le protocole officiel ; des frais de paiement sur le montant capture et, en cas de contestation ulterieure, d?eventuels frais de litige peuvent alors s?appliquer selon le reseau de carte.', 10, true, '2025-08-23T20:32:57.601574+00:00'),
...
(27, 'Pourquoi certains documents sont-ils demandés??', 'Certains objets nécessitent des justificatifs (identité, justificatif de domicile, etc.) afin de sécuriser la location.', 17, true, '2026-01-09T09:51:49.164924+00:00'),
...
('payment_received', '💰 Paiement reçu !', '<h1>Paiement confirmé</h1><p>Le paiement de {{amount}}€ pour la location de {{item_title}} a été reçu.</p><p>Vous recevrez {{owner_net}}€ apr?s deduction des frais applicables a la location (commission plateforme et frais de paiement de la location).</p><p>Aucun frais n?est applique sur l?empreinte CB tant qu?elle n?est pas capturee. En cas de capture validee apres litige, des frais de paiement sur le montant capture et, le cas echeant, des frais de litige peuvent s?appliquer selon le reseau de carte.</p>', NULL, true, '2026-02-15T16:53:38.713381+00:00', '2026-02-19T10:15:35.266528+00:00'),
