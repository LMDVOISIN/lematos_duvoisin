-- ============================================================
-- Rebuild chat RLS policies (no recursion + participant-safe)
-- Date: 2026-03-03
--
-- Why:
-- - Some environments still return chat RLS errors when opening a reservation chat.
-- - Previous hotfixes could leave helper functions and policies out of sync.
--
-- This migration is idempotent and does three things:
-- 1) harden helper functions with SECURITY DEFINER + row_security=off
-- 2) rebuild chat policies on conversations / conversation_participants
-- 3) grant explicit table privileges required by the web app role
-- ============================================================
